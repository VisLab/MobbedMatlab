%% revised pop_biosig() by Kyung, April 30, 2012
%  - call k_bigsig2eeglab instead of original bigsig2eeglab
%  - k_bigsig2eeglab has the fixed code to import event information
...
function [EEG, command, dat] = k_pop_biosig(filename, varargin) 
EEG = [];
command = '';
...
% call k_biosig2eeglab instead of biosig2eeglab. by Kyung Apr 30, 2012
EEG = k_biosig2eeglab(dat, DAT, interval, g.channels, strcmpi(g.importevent, 'on'));
